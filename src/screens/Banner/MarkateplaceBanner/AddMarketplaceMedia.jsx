...
const AddMarketplaceMedia = () => {
    ...
    const handleUpdate = async () => {
        ...
        try {
            ...
            const response = await API.post("api/admin/media", bodyData);
            if (response.status === 200) {
    ...
    return (
        <div className="markateplaceBannerWrapper mb-2">
            <PageHeader
                headerTitle={"Add Marketplace Media"}
                isBtn={true}
                type="back"
            ...
            />
            <ProductTopHead
                title={"Markateplace Brand / Boutiques / Product Info "}
            />
            <div>
                ...
                {(formData?.type === "brand" ||
                    ...
                    <div className="marketplaceBannerInputContainer my-5">
                        <div className="marketplaceBannerAutoInput">
                            <Autocomplete
                                id="combo-box-demo"
                                options={
                                    formData?.type === "brand"
...
export default AddMarketplaceMedia;
